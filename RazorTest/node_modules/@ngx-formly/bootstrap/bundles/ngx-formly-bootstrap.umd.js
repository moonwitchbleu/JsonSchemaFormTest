(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/forms'), require('@ngx-formly/core'), require('@ngx-formly/core/select'), require('@ngx-formly/bootstrap/addons')) :
    typeof define === 'function' && define.amd ? define('@ngx-formly/bootstrap', ['exports', '@angular/core', '@angular/common', '@angular/forms', '@ngx-formly/core', '@ngx-formly/core/select', '@ngx-formly/bootstrap/addons'], factory) :
    (factory((global['ngx-formly'] = global['ngx-formly'] || {}, global['ngx-formly'].bootstrap = {}),global.ng.core,global.ng.common,global.ng.forms,global.core$1,global.select,global['ngx-formly'].bootstrap.addons));
}(this, (function (exports,core,common,forms,core$1,select,addons) { 'use strict';
